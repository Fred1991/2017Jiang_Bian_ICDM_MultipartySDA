%function [sparseBeta, F1, precision, recall, F1Max, AccMax, AUC] = benchmarkDS(lambdaGlasso)
function [sparseBeta, F1, precision, recall, F1Max, AccMax, AUC] = benchmarkDS(lambdaGlasso,numTrainDat)
%function [accuracy, F1, precision, recall] = benchmarkDS(lambdaGlasso,numTrainDat)
%function benchmarkDS
% dataset load
%clear;
%clc;
