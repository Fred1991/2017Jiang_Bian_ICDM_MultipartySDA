%function [disBeta, F1, precision, recall, F1Max, AccMax, AUC] = benchmarkDis(lambdaGlasso)
%function [disBeta, F1, precision, recall, F1Max, AccMax, AUC] = benchmarkDis(lambdaGlasso,numTrainDat)
%function [accuracy, F1, precision, recall] = benchmarkDis(lambdaGlasso,numTrainDat)
function benchmarkDis
% dataset load
%clear;
%clc;
