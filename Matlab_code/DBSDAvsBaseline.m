...
plot(x,slices{2}.Var9','--o','color','k');%dtree
plot(x,slices{8}.Var9','--s','color','k');%rfc
%plot(x,slices{9}.Var9','-o','color','k');
plot(x,slices{7}.Var9','--d','color','b');%Nsvm 10.0

plot(x,slices{16}.Var9','--x','color','b');%svmlinear
...
[L,icons] = legend('Decision Tree','Random Forest','Kernel SVM','Linear SVM','DBSDA','Location','NorthEastOutside');
set(L,'fontsize',20);
for k = 1:5
icons(k).FontSize = 16;
end
