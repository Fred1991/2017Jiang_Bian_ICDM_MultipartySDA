%function [sparseBeta, F1, precision, recall, F1Max, AccMax, AUC] = spliceDS(lambdaGlasso)
function [sparseBeta, F1, precision, recall, F1Max, AccMax, AUC] = spliceDS(lambdaGlasso,numTrainDat)
