%function [disBeta, F1, precision, recall, F1Max, AccMax, AUC] = spliceDis(lambdaGlasso)
function [disBeta, F1, precision, recall, F1Max, AccMax, AUC] = spliceDis(lambdaGlasso,numTrainDat)
